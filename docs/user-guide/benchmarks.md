...
- Document updated: 2026-09-07 13:57:37 UTC
...
| --- | --- | --- |
| DecentDB | 2.17.2 | Workspace package version |
...
| --- | --- | --- | ---: | ---: | --- | --- |
| Workload C | Full scan | SQLite_wal_full | 632.66 | 1273.71 | 3rd of 6 | Trailing |
| Workload C | Point select | SQLite_wal_full | 6.38 | 14.09 | 2nd of 6 | Near the front |
| Workload A | Point select | SQLite_wal_full | 6.25 | 16.79 | 2nd of 6 | Near the front |
| Workload A | Aggregate | SQLite_wal_full | 58.76 | 147.43 | 2nd of 6 | Near the front |
| Workload A | Join | SQLite_wal_full | 29.77 | 247.08 | 2nd of 6 | Near the front |
| Workload A | Range scan | SQLite_wal_full | 6.07 | 29.81 | 2nd of 6 | Near the front |
| Workload A | Delete | H2(JDBC) | 39.74 | 455.60 | 5th of 6 | Trailing |
| Workload A | Update | H2(JDBC) | 46.53 | 523.13 | 5th of 6 | Trailing |
